...
if !File.exist?(config_file)
  byebug
  config_file = Rails.root.to_s+"/config/codingstack.yml"
end
...
# check config
begin
  known_options = YAML.load_file(Rails.root.to_s+"/config/codingstack.yml")[Rails.env]
  if known_options
...
REPUTATION_REWARDS = YAML.load_file(Rails.root.to_s+"/config/default_reputation.yml")
...
AppConfig.version = File.read(Rails.root.to_s+"/VERSION")
